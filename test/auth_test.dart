...
import 'package:hello_world/services/auth/auth_exception.dart';
import 'package:hello_world/services/auth/auth_provider.dart';
import 'package:hello_world/services/auth/auth_user.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test(
      'Should be initialized  in less than 2s',
      () async {
        await provider.initialize();
